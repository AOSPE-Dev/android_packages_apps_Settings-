...
public class DeviceInfoSettings extends SettingsPreferenceFragment {
    ...
    private static final String KEY_AOSPE_VERSION = "aospe_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        findPreference(KEY_AOSPE_VERSION).setEnabled(true);
        setValueSummary(KEY_AOSPE_VERSION , "ro.aospe.version");
...
Log.i("EASTER",preference.getKey().toString());
        if (preference.getKey().equals(KEY_FIRMWARE_VERSION)) {
        ...
        } else if (preference.getKey().equals(KEY_AOSPE_VERSION)) {
            ...
            if (mTaps[0] >= (SystemClock.uptimeMillis()-500)) {
                Intent intent = new Intent(Intent.ACTION_MAIN);
                intent.setClassName("android",
                        com.android.internal.app.PELogo.class.getName());
                try {
                    startActivity(intent);
                } catch (Exception e) {
                    Log.e(LOG_TAG, "Unable to start activity " + intent.toString());
